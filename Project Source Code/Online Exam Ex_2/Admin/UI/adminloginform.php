...
?>
  ...
  <body>
      ...
      <div id="wrap">
                ...
                <div id="header">
                  <img  height="120" width="132" src="../../Website/UI/images/coc.png"/>
                  <h1 id="logo">Online Examination System<span class="gray"> For OCACC</span></h1>
				 
        </div>
     <form id="adminloginform" action="<?php $_SERVER['../DOCUMENT_ROOT']; ?>."/Online Exam Ex_2/Admin/index.php" method="POST">
      <div class="menu">
      ...
      <div class="box">
           ...
           <?php
             ...
             ?>
              ...
              <tr>
                  <td colspan="2">
                      <input type="submit" tabindex="3" value="Log In" name="admsubmit" class="button" />
                  </td><td></td>
              </tr>
            </table>
</ul>
